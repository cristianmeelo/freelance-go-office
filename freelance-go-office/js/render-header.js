...
<header id="header-renderized-desktop" class="header">
  ...
  <div id="desktop-left-menu" class="desktop-left-menu">
    ...
    <div id="desktop-products-container" class="desktop-products-container">
      <!-- As categorias e subcategorias serão inseridas dinamicamente pelo JavaScript -->
    </div>
  </div>
</header>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const renderDesktopProductsMenu = () => {
    const productsContainer = document.querySelector(".desktop-products-container");

    // Cria o cabeçalho "Produtos" com o ícone de fechar
  ...
  `;
    ...
    products.forEach((productData) => {
      ...
      // Adiciona a opção "Ver tudo" no final de cada categoria
      const viewAllOption = document.createElement("li");
    ...
    // Adiciona funcionalidade para fechar o menu
